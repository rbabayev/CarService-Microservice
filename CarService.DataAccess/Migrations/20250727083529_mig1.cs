        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopPoint = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    WorkerPoint = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ConfirmPassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShopName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WorkerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShopCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuctionProducts_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuctionBids_AuctionProducts_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AuctionProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuctionTransactions_AspNetUsers_WinnerUserId",
                        column: x => x.WinnerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuctionTransactions_AuctionProducts_AuctionProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionProducts_SellerId",
                table: "AuctionProducts",
                column: "SellerId");

            migrationBuilder.CreateIndex(
                name: "IX_AuctionTransactions_AuctionProductId",
                table: "AuctionTransactions",
                column: "AuctionProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AuctionTransactions_WinnerUserId",
                table: "AuctionTransactions",
                column: "WinnerUserId");
